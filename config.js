...
module.exports = {
    ...
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'ᴀʙᴜ sᴇʀ🥂' : process.env.ALIVE_BUTTON,
    ALIVEBTN2: process.env.ALIVE_BUTTON2 === undefined ? 'ᴘᴏᴡᴏʟɪ ᴀʟʟᴇ ᴀʙᴜ sᴇʀ🤩' : process.env.ALIVE_BUTTON2,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? '💖ᴀʙᴜ sᴇʀ💖' : process.env.OWNER_NAME,
    ...
    AFPLK: process.env.ABU_PASSWORD === undefined ? false : process.env.JOCKER_PASSWORD,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Jocker_v2' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 ᴀʙᴜ sᴇʀ 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    TALKING_MAALUTTY: process.env.TALKING_ABU === undefined ? 'false' : process.env.TALKING_ABU,
